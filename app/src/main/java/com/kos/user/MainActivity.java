            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.list_kos:
                        ...
                        return true;
                    case R.id.cari_kos:
                        cari_kos cari = new cari_kos();
                        android.support.v4.app.FragmentTransaction fragmentTransaction_cari = getSupportFragmentManager().beginTransaction();
                        fragmentTransaction_cari.replace(R.id.frame,cari);
                        fragmentTransaction_cari.commit();
                        return true;
                    default:
